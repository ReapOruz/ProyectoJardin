...
namespace Jardin.Entidades
{
    public class Grupos
    {
        ...
        public Grupos(string nombre, int grado, int alumnos, int docente, int salon)
        {
        ...
        public Grupos(string nombre, string nomAnterior, int grado, int alumnos, int docente, int salon)
        {
